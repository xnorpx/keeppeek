...
| **Hikvision / Annke**                       | SADP discovery, ONVIF/RTSP media, and a plain-Rust ISAPI event worker                                       | Native event support depends on model, firmware, channel mapping, and enabled camera rules; see the [ISAPI guide](https://github.com/xnorpx/keeppeek/blob/main/docs/hikvision-isapi.md) |
...
| **Native camera events**        | Reolink Baichuan and compatible Hikvision/Annke ISAPI                                | Normalize supported alarms into stored/live events; classifications require event evidence, and image association is protocol-specific |
