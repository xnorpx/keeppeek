...
Load and follow the canonical vendor-neutral workflow at
[`../../../.agents/skills/setup-repo/SKILL.md`](../../../.agents/skills/setup-repo/SKILL.md).

The canonical skill is authoritative. Apply its platform detection, version pins, package policy,
privilege boundaries, dependency installation, and validation gates.
