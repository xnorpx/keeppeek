...
#[expect(
    ...
    reason = "TestRequest only supplies valid HTTP components to new_request."
)]
impl From<TestRequest> for Request {
    fn from(mut mock: TestRequest) -> Self {
...
impl TestRequest {
    ...
    pub const fn with_body(mut self, body: &'static str) -> Self {
        self.body = body;
        self
    }
    pub const fn with_remote_addr(mut self, remote_addr: SocketAddr) -> Self {
        self.remote_addr = remote_addr;
        self
    }
    pub const fn with_https(mut self) -> Self {
        self.secure = true;
        self
    }
    ...
    pub const fn with_http_version(mut self, version: HTTPVersion) -> Self {
