...
fn gzip(response: &mut Response) {
    ...
    let mut src = size.map_or_else(Vec::new, Vec::with_capacity);
...
mod tests {
    ...
    fn no_req_encodings() {
        ...
        assert!(
            !encoded_response
                .headers
                .iter()
                .any(|(header_name, _)| header_name == "Content-Encoding")
    ...
    fn unknown_req_encoding() {
        ...
        ); // Brotli Content-Encoding header
    }
    ...
    fn gzip_encoding() {
        ...
        assert!(
            encoded_response
                .headers
                .contains(&("Content-Encoding".into(), "gzip".into()))
