...
use chrono::{FixedOffset, NaiveTime, format::strftime::StrftimeItems};
...
impl Time {
    pub const fn from_chrono_naive_time(time: NaiveTime) -> Self {
        Self {
            value: time,
            timezone: None,
        }
    ...
    pub const fn to_chrono_naive_time(&self) -> NaiveTime {
        self.value
    }
}
