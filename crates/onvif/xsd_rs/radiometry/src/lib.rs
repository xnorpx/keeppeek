...
#[yaserde(
    prefix = "ttr",
    namespaces = { "ttr" = "http://www.onvif.org/ver20/analytics/radiometry" }
)]
...
pub struct SpotTemperatureReading {
    ...
    #[yaserde(attribute = true, rename = "SpotTemperature")]
...
pub struct BoxTemperatureReading {
    ...
    #[yaserde(attribute = true, rename = "MaxTemperature")]
    pub max_temperature: f64,

    #[yaserde(attribute = true, rename = "MinTemperature")]
    pub min_temperature: f64,

    #[yaserde(attribute = true, rename = "AverageTemperature")]
    pub average_temperature: Option<f64>,

    #[yaserde(attribute = true, rename = "MedianTemperature")]
...
pub struct RadiometryTemperatureRuleConfig {
    ...
    #[yaserde(attribute = true, rename = "RadiometryModuleID")]
