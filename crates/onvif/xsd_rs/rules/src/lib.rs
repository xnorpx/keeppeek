...
#[yaserde(
    prefix = "axt",
    namespaces = { "axt" = "http://www.onvif.org/ver20/analytics" }
)]
pub struct MotionRegionConfigOptions {
    ...
    #[yaserde(attribute = true, rename = "PTZPresetMotionSupport")]
...
pub struct MotionRegionConfig {
    ...
    // (motion is
    // not being detected).
    #[yaserde(attribute = true, rename = "Armed")]
    ...
    #[yaserde(attribute = true, rename = "Sensitivity")]
