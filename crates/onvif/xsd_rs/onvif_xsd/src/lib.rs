...
#[yaserde(prefix = "tt", namespaces = { "tt" = "http://www.onvif.org/ver10/schema" })]
...
pub struct IntRectangle {
    #[yaserde(attribute = true, rename = "x")]
    pub x: i32,

    #[yaserde(attribute = true, rename = "y")]
    pub y: i32,

    #[yaserde(attribute = true, rename = "width")]
    pub width: i32,

    #[yaserde(attribute = true, rename = "height")]
    pub height: i32,
}
...
pub struct VideoSourceConfiguration {
    ...
    #[yaserde(attribute = true, rename = "ViewMode")]
...
pub struct LensDescription {
    ...
    #[yaserde(attribute = true, rename = "FocalLength")]
...
pub struct RotateOptions {
    ...
    // false.
    #[yaserde(attribute = true, rename = "Reboot")]
...
pub struct VideoEncoderConfiguration {
    ...
    #[yaserde(attribute = true, rename = "GuaranteedFrameRate")]
...
pub struct VideoEncoderConfigurationOptions {
    ...
    #[yaserde(attribute = true, rename = "GuaranteedFrameRateSupported")]
...
pub struct VideoRateControl2 {
    ...
    #[yaserde(attribute = true, rename = "ConstantBitRate")]
...
pub struct VideoEncoder2ConfigurationOptions {
    ...
    // to the I-Frame distance.
    #[yaserde(attribute = true, rename = "GovLengthRange")]
...
pub struct BinaryData {
    ...
    #[yaserde(attribute = true, prefix = "xmime", rename = "contentType")]
...
pub struct CertificateUsage {
    #[yaserde(attribute = true, rename = "Critical")]
    pub critical: bool,
}
...
pub struct DigitalInput {
    ...
    #[yaserde(attribute = true, rename = "IdleState")]
...
pub struct PtzconfigurationOptions {
    ...
    #[yaserde(attribute = true, rename = "PTZRamps")]
...
pub struct PtzpresetTourStartingCondition {
    ...
    // recalled randomly.
    #[yaserde(attribute = true, rename = "RandomPresetOrder")]
...
pub struct FocusConfiguration20 {
    ...
    #[yaserde(attribute = true, rename = "AFMode")]
...
pub struct Message {
    ...
    #[yaserde(attribute = true, rename = "UtcTime")]
    pub utc_time: xs::DateTime,

    #[yaserde(attribute = true, rename = "PropertyOperation")]
...
pub struct MessageDescription {
    ...
    #[yaserde(attribute = true, rename = "IsProperty")]
...
pub struct CellLayout {
    ...
    #[yaserde(attribute = true, rename = "Columns")]
    pub columns: xs::Integer,

    // Number of rows of the cell grid (y dimension)
    #[yaserde(attribute = true, rename = "Rows")]
    pub rows: xs::Integer,
}
...
pub struct MetadataAttributes {
    ...
    #[yaserde(attribute = true, rename = "PtzSpaces")]
...
pub struct RecordingJobConfiguration {
    ...
    #[yaserde(attribute = true, rename = "ScheduleToken")]
...
pub struct Osdcolor {
    ...
    #[yaserde(attribute = true, rename = "Transparent")]
...
pub struct OsdtextConfiguration {
    ...
    #[yaserde(attribute = true, rename = "IsPersistentText")]
...
pub struct OsdimgOptions {
    ...
    #[yaserde(attribute = true, rename = "FormatsSupported")]
    ...
    #[yaserde(attribute = true, rename = "MaxWidth")]
    pub max_width: Option<i32>,

    // The maximum height (in pixels) of the image that can be uploaded.
    #[yaserde(attribute = true, rename = "MaxHeight")]
...
pub struct MaximumNumberOfOSDs {
    #[yaserde(attribute = true, rename = "Total")]
    pub total: i32,

    #[yaserde(attribute = true, rename = "Image")]
    pub image: Option<i32>,

    #[yaserde(attribute = true, rename = "PlainText")]
    pub plain_text: Option<i32>,

    #[yaserde(attribute = true, rename = "Date")]
    pub date: Option<i32>,

    #[yaserde(attribute = true, rename = "Time")]
    pub time: Option<i32>,

    #[yaserde(attribute = true, rename = "DateAndTime")]
