...
#[yaserde(
    prefix = "tns",
    namespaces = { "tns" = "http://www.w3.org/2003/05/soap-envelope" }
)]
pub struct Envelope {
...
impl Fault {
    pub fn is_unauthorized(&self) -> bool {
        self.code
            .subcode
            .as_ref()
            .is_some_and(|subcode| subcode.value.contains("NotAuthorized"))
    }
}
...
pub struct Reasontext {
    #[yaserde(attribute = true, prefix = "xml", rename = "lang")]
    pub lang: String,
...
pub struct NotUnderstoodType {
    #[yaserde(attribute = true, rename = "qname")]
    pub qname: String,
}
