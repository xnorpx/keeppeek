...
pub struct Vector2D {
    ...
    #[yaserde(attribute = true, rename = "space")]
...
pub struct Rectangle {
    #[yaserde(attribute = true, rename = "bottom")]
    pub bottom: Option<f64>,

    #[yaserde(attribute = true, rename = "top")]
    pub top: Option<f64>,

    #[yaserde(attribute = true, rename = "right")]
    pub right: Option<f64>,

    #[yaserde(attribute = true, rename = "left")]
    pub left: Option<f64>,
}
...
pub struct Color {
    ...
    #[yaserde(attribute = true, rename = "Z")]
    pub z: f64,
...
pub struct ColorCovariance {
    #[yaserde(attribute = true, rename = "XX")]
    pub xx: f64,

    #[yaserde(attribute = true, rename = "YY")]
    pub yy: f64,

    #[yaserde(attribute = true, rename = "ZZ")]
    pub zz: f64,

    #[yaserde(attribute = true, rename = "XY")]
    pub xy: Option<f64>,

    #[yaserde(attribute = true, rename = "XZ")]
    pub xz: Option<f64>,

    #[yaserde(attribute = true, rename = "YZ")]
    pub yz: Option<f64>,
...
pub struct GeoLocation {
    ...
    #[yaserde(attribute = true, rename = "lon")]
    pub lon: Option<f64>,

    // North south location as angle.
    #[yaserde(attribute = true, rename = "lat")]
    pub lat: Option<f64>,

    // Hight in meters above sea level.
    #[yaserde(attribute = true, rename = "elevation")]
...
pub struct GeoOrientation {
    ...
    #[yaserde(attribute = true, rename = "roll")]
    pub roll: Option<f64>,

    // Rotation around the y axis.
    #[yaserde(attribute = true, rename = "pitch")]
    pub pitch: Option<f64>,

    // Rotation around the z axis.
    #[yaserde(attribute = true, rename = "yaw")]
    pub yaw: Option<f64>,
}
...
pub struct LocalOrientation {
    // Rotation around the y axis.
    #[yaserde(attribute = true, rename = "pan")]
    pub pan: Option<f64>,

    // Rotation around the z axis.
    #[yaserde(attribute = true, rename = "tilt")]
    pub tilt: Option<f64>,
...
pub struct LocationEntity {
    ...
    // enumeration.
    #[yaserde(attribute = true, rename = "Entity")]
    ...
    // service.
    #[yaserde(attribute = true, rename = "GeoSource")]
