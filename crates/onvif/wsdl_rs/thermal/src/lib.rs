...
#[yaserde(
    prefix = "tth",
    namespaces = { "tth" = "http://www.onvif.org/ver10/thermal/wsdl" }
)]
...
pub struct Capabilities {
    ...
    #[yaserde(attribute = true, rename = "Radiometry")]
...
pub fn get_radiometry_configuration_options<T: transport::Transport>(
    transport: &T,
...
pub fn get_radiometry_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn set_radiometry_configuration<T: transport::Transport>(
    transport: &T,
