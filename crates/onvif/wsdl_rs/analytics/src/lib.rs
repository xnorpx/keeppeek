...
#[yaserde(
    prefix = "tan",
    namespaces = { "tan" = "http://www.onvif.org/ver20/analytics/wsdl" }
)]
...
pub struct Capabilities {
    ...
    // rules interface
    #[yaserde(attribute = true, rename = "RuleOptionsSupported")]
    ...
    #[yaserde(attribute = true, rename = "AnalyticsModuleOptionsSupported")]
...
pub struct ConfigOptions {
    ...
    // ambiguous.
    #[yaserde(attribute = true, rename = "RuleType")]
    pub rule_type: Option<String>,
    ...
    #[yaserde(attribute = true, rename = "AnalyticsModule")]
...
pub fn get_supported_analytics_modules<T: transport::Transport>(
    transport: &T,
...
// attribute.
pub fn get_analytics_module_options<T: transport::Transport>(
    transport: &T,
...
pub fn create_analytics_modules<T: transport::Transport>(
    transport: &T,
...
pub fn delete_analytics_modules<T: transport::Transport>(
    transport: &T,
...
// VideoAnalyticsConfiguration.
pub fn get_analytics_modules<T: transport::Transport>(
    transport: &T,
...
pub fn modify_analytics_modules<T: transport::Transport>(
    transport: &T,
...
pub fn get_supported_rules<T: transport::Transport>(
    transport: &T,
...
// The available supported types can be retrieved via
pub fn create_rules<T: transport::Transport>(
    transport: &T,
    request: &CreateRules,
...
pub fn delete_rules<T: transport::Transport>(
    transport: &T,
    request: &DeleteRules,
...
pub fn get_rules<T: transport::Transport>(
    transport: &T,
    request: &GetRules,
...
pub fn get_rule_options<T: transport::Transport>(
    transport: &T,
...
// referenced by their names.
pub fn modify_rules<T: transport::Transport>(
    transport: &T,
    request: &ModifyRules,
