...
#[yaserde(
    prefix = "trp",
    namespaces = { "trp" = "http://www.onvif.org/ver10/replay/wsdl" }
)]
...
pub struct Capabilities {
    ...
    #[yaserde(attribute = true, rename = "ReversePlayback")]
    ...
    #[yaserde(attribute = true, rename = "SessionTimeoutRange")]
...
pub fn get_replay_uri<T: transport::Transport>(
    transport: &T,
...
// This operation is mandatory.
pub fn get_replay_configuration<T: transport::Transport>(
    transport: &T,
...
// This operation is mandatory.
pub fn set_replay_configuration<T: transport::Transport>(
    transport: &T,
