...
#[yaserde(
    prefix = "tdc",
    namespaces = { "tdc" = "http://www.onvif.org/ver10/doorcontrol/wsdl" }
)]
pub struct ServiceCapabilities {
    ...
    #[yaserde(attribute = true, rename = "MaxDoors")]
...
pub struct DoorCapabilities {
    ...
    #[yaserde(attribute = true, rename = "DoubleLock")]
    ...
    #[yaserde(attribute = true, rename = "LockDown")]
...
pub fn get_door_info_list<T: transport::Transport>(
    transport: &T,
...
pub fn get_door_info<T: transport::Transport>(
    transport: &T,
    request: &GetDoorInfo,
...
pub fn get_door_list<T: transport::Transport>(
    transport: &T,
    request: &GetDoorList,
...
// If the number of requested items is greater than MaxLimit, a TooManyItems
// fault shall be returned.
pub fn get_doors<T: transport::Transport>(
    transport: &T,
    request: &GetDoors,
...
pub fn create_door<T: transport::Transport>(
    transport: &T,
    request: &CreateDoor,
...
pub fn set_door<T: transport::Transport>(
    transport: &T,
    request: &SetDoor,
...
// If no token was specified in the request, the device shall return InvalidArgs
// as a generic fault code.
pub fn modify_door<T: transport::Transport>(
    transport: &T,
    request: &ModifyDoor,
...
// If no token was specified in the request, the device shall return InvalidArgs
// as a generic fault code.
pub fn delete_door<T: transport::Transport>(
    transport: &T,
    request: &DeleteDoor,
...
pub fn get_door_state<T: transport::Transport>(
    transport: &T,
...
pub fn access_door<T: transport::Transport>(
    transport: &T,
    request: &AccessDoor,
...
// restrictions.
pub fn lock_door<T: transport::Transport>(
    transport: &T,
    request: &LockDoor,
...
// Please refer to section [DoorMode] for more details about Door Modes
// restrictions.
pub fn unlock_door<T: transport::Transport>(
    transport: &T,
    request: &UnlockDoor,
...
// Please refer to section [DoorMode] for more details about Door Modes
// restrictions.
pub fn block_door<T: transport::Transport>(
    transport: &T,
    request: &BlockDoor,
...
// Please refer to section [DoorMode] for more details about Door Modes
// restrictions.
pub fn lock_down_door<T: transport::Transport>(
    transport: &T,
...
pub fn lock_down_release_door<T: transport::Transport>(
    transport: &T,
...
// Please refer to section [DoorMode] for more details about Door Modes
// restrictions.
pub fn lock_open_door<T: transport::Transport>(
    transport: &T,
...
pub fn lock_open_release_door<T: transport::Transport>(
    transport: &T,
...
// If the request cannot be fulfilled, a Failure fault shall be returned.
pub fn double_lock_door<T: transport::Transport>(
    transport: &T,
