...
#[yaserde(
    prefix = "tup",
    namespaces = { "tup" = "http://www.onvif.org/ver10/uplink/wsdl" }
)]
...
pub struct Capabilities {
    ...
    #[yaserde(attribute = true, rename = "MaxUplinks")]
...
// Online.
pub fn get_uplinks<T: transport::Transport>(
    transport: &T,
    request: &GetUplinks,
...
// create a new entry.
pub fn set_uplink<T: transport::Transport>(
    transport: &T,
    request: &SetUplink,
...
// configuration.
pub fn delete_uplink<T: transport::Transport>(
    transport: &T,
