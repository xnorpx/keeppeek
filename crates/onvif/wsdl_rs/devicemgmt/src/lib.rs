...
pub struct SystemCapabilities {
    ...
    #[yaserde(attribute = true, rename = "GeoLocationEntries")]
...
pub struct MiscCapabilities {
    ...
    #[yaserde(attribute = true, rename = "AuxiliaryCommands")]
...
pub fn get_services<T: transport::Transport>(
    transport: &T,
    request: &GetServices,
...
// command.
pub fn set_system_date_and_time<T: transport::Transport>(
    transport: &T,
...
// values.
pub fn set_system_factory_default<T: transport::Transport>(
    transport: &T,
...
pub fn upgrade_system_firmware<T: transport::Transport>(
    transport: &T,
...
pub fn system_reboot<T: transport::Transport>(
    transport: &T,
...
pub fn restore_system<T: transport::Transport>(
    transport: &T,
...
// this standard.
pub fn get_system_backup<T: transport::Transport>(
    transport: &T,
...
pub fn get_system_log<T: transport::Transport>(
    transport: &T,
...
pub fn get_system_support_information<T: transport::Transport>(
    transport: &T,
...
// parameters are of
// two different types:
pub fn get_scopes<T: transport::Transport>(
    transport: &T,
    request: &GetScopes,
...
// command.
pub fn set_scopes<T: transport::Transport>(
    transport: &T,
    request: &SetScopes,
...
pub fn add_scopes<T: transport::Transport>(
    transport: &T,
    request: &AddScopes,
...
// command.
// Table
pub fn remove_scopes<T: transport::Transport>(
    transport: &T,
...
pub fn get_discovery_mode<T: transport::Transport>(
    transport: &T,
...
pub fn set_discovery_mode<T: transport::Transport>(
    transport: &T,
...
// command.
pub fn get_remote_discovery_mode<T: transport::Transport>(
    transport: &T,
...
pub fn set_remote_discovery_mode<T: transport::Transport>(
    transport: &T,
...
pub fn get_dp_addresses<T: transport::Transport>(
    transport: &T,
...
pub fn set_dp_addresses<T: transport::Transport>(
    transport: &T,
...
// service
// endpoint reference.
pub fn get_endpoint_reference<T: transport::Transport>(
    transport: &T,
...
// as a HTTP / RTSP user.
pub fn get_remote_user<T: transport::Transport>(
    transport: &T,
...
// RTSP user.
pub fn set_remote_user<T: transport::Transport>(
    transport: &T,
...
pub fn get_users<T: transport::Transport>(
    transport: &T,
    request: &GetUsers,
...
pub fn create_users<T: transport::Transport>(
    transport: &T,
    request: &CreateUsers,
...
pub fn delete_users<T: transport::Transport>(
    transport: &T,
    request: &DeleteUsers,
...
pub fn set_user<T: transport::Transport>(
    transport: &T,
    request: &SetUser,
...
// GetWsdlUrl command.
pub fn get_wsdl_url<T: transport::Transport>(
    transport: &T,
    request: &GetWsdlUrl,
...
// methods.
pub fn get_capabilities<T: transport::Transport>(
    transport: &T,
...
pub fn get_hostname<T: transport::Transport>(
    transport: &T,
    request: &GetHostname,
...
pub fn set_hostname<T: transport::Transport>(
    transport: &T,
    request: &SetHostname,
...
// DHCP.
pub fn set_hostname_from_dhcp<T: transport::Transport>(
    transport: &T,
...
pub fn get_dns<T: transport::Transport>(
    transport: &T,
    request: &GetDNS,
...
pub fn set_dns<T: transport::Transport>(
    transport: &T,
    request: &SetDNS,
...
pub fn get_ntp<T: transport::Transport>(
    transport: &T,
    request: &GetNTP,
...
pub fn set_ntp<T: transport::Transport>(
    transport: &T,
    request: &SetNTP,
...
pub fn get_dynamic_dns<T: transport::Transport>(
    transport: &T,
...
pub fn set_dynamic_dns<T: transport::Transport>(
    transport: &T,
...
pub fn get_network_interfaces<T: transport::Transport>(
    transport: &T,
...
// command.
pub fn set_network_interfaces<T: transport::Transport>(
    transport: &T,
...
pub fn get_network_protocols<T: transport::Transport>(
    transport: &T,
...
// command.
pub fn set_network_protocols<T: transport::Transport>(
    transport: &T,
...
// address(es).
pub fn get_network_default_gateway<T: transport::Transport>(
    transport: &T,
...
// command.
pub fn set_network_default_gateway<T: transport::Transport>(
    transport: &T,
...
pub fn get_zero_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn set_zero_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn get_ip_address_filter<T: transport::Transport>(
    transport: &T,
...
// SetIPAddressFilter
// command.
pub fn set_ip_address_filter<T: transport::Transport>(
    transport: &T,
...
// command.
pub fn add_ip_address_filter<T: transport::Transport>(
    transport: &T,
...
pub fn remove_ip_address_filter<T: transport::Transport>(
    transport: &T,
...
pub fn get_access_policy<T: transport::Transport>(
    transport: &T,
...
// command.
pub fn set_access_policy<T: transport::Transport>(
    transport: &T,
...
pub fn create_certificate<T: transport::Transport>(
    transport: &T,
...
// [X.690] encoding
// rules.
pub fn get_certificates<T: transport::Transport>(
    transport: &T,
...
pub fn get_certificates_status<T: transport::Transport>(
    transport: &T,
...
// time.
pub fn set_certificates_status<T: transport::Transport>(
    transport: &T,
...
pub fn delete_certificates<T: transport::Transport>(
    transport: &T,
...
pub fn get_pkcs_10_request<T: transport::Transport>(
    transport: &T,
...
pub fn load_certificates<T: transport::Transport>(
    transport: &T,
...
// supports TLS shall
// support this command.
pub fn get_client_certificate_mode<T: transport::Transport>(
    transport: &T,
...
// supports TLS shall
// support this command.
pub fn set_client_certificate_mode<T: transport::Transport>(
    transport: &T,
...
pub fn get_relay_outputs<T: transport::Transport>(
    transport: &T,
...
pub fn set_relay_output_settings<T: transport::Transport>(
    transport: &T,
...
pub fn set_relay_output_state<T: transport::Transport>(
    transport: &T,
...
pub fn send_auxiliary_command<T: transport::Transport>(
    transport: &T,
...
pub fn get_ca_certificates<T: transport::Transport>(
    transport: &T,
...
// can choose the ID
// accordingly.
pub fn load_certificate_with_private_key<T: transport::Transport>(
    transport: &T,
...
pub fn get_certificate_information<T: transport::Transport>(
    transport: &T,
...
pub fn load_ca_certificates<T: transport::Transport>(
    transport: &T,
...
// some configuration
// conflict.
pub fn create_dot_1x_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn set_dot_1x_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn get_dot_1x_configuration<T: transport::Transport>(
    transport: &T,
...
// configured.
pub fn get_dot_1x_configurations<T: transport::Transport>(
    transport: &T,
...
pub fn delete_dot_1x_configuration<T: transport::Transport>(
    transport: &T,
...
// this operation.
pub fn get_dot_11_capabilities<T: transport::Transport>(
    transport: &T,
...
// shall support this
// command.
pub fn get_dot_11_status<T: transport::Transport>(
    transport: &T,
...
pub fn scan_available_dot_11_networks<T: transport::Transport>(
    transport: &T,
...
pub fn get_system_uris<T: transport::Transport>(
    transport: &T,
...
pub fn start_firmware_upgrade<T: transport::Transport>(
    transport: &T,
...
// scope of this
// specification.
pub fn start_system_restore<T: transport::Transport>(
    transport: &T,
...
pub fn get_storage_configurations<T: transport::Transport>(
    transport: &T,
...
// (remain after reboot).
pub fn create_storage_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn get_storage_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn set_storage_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn delete_storage_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn get_geo_location<T: transport::Transport>(
    transport: &T,
...
pub fn set_geo_location<T: transport::Transport>(
    transport: &T,
...
pub fn delete_geo_location<T: transport::Transport>(
    transport: &T,
