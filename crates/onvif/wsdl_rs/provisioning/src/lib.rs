...
#[yaserde(
    prefix = "tpv",
    namespaces = { "tpv" = "http://www.onvif.org/ver10/provisioning/wsdl" }
)]
pub struct Usage {
...
pub struct SourceCapabilities {
    ...
    #[yaserde(attribute = true, rename = "VideoSourceToken")]
    ...
    #[yaserde(attribute = true, rename = "MaximumPanMoves")]
    ...
    #[yaserde(attribute = true, rename = "MaximumTiltMoves")]
    ...
    #[yaserde(attribute = true, rename = "MaximumZoomMoves")]
...
pub fn pan_move<T: transport::Transport>(
    transport: &T,
    request: &PanMove,
...
pub fn tilt_move<T: transport::Transport>(
    transport: &T,
    request: &TiltMove,
...
pub fn zoom_move<T: transport::Transport>(
    transport: &T,
    request: &ZoomMove,
...
pub fn roll_move<T: transport::Transport>(
    transport: &T,
    request: &RollMove,
...
pub fn focus_move<T: transport::Transport>(
    transport: &T,
    request: &FocusMove,
...
pub fn get_usage<T: transport::Transport>(
    transport: &T,
    request: &GetUsage,
