...
#[yaserde(
    prefix = "tar",
    namespaces = { "tar" = "http://www.onvif.org/ver10/accessrules/wsdl" }
)]
...
pub fn get_access_profile_info<T: transport::Transport>(
    transport: &T,
...
pub fn get_access_profile_info_list<T: transport::Transport>(
    transport: &T,
...
// If the number of requested items is greater than MaxLimit, a TooManyItems
// fault shall be returned.
pub fn get_access_profiles<T: transport::Transport>(
    transport: &T,
...
// available. The reference shall be valid for retrieving the next set of data.
// The number of items returned shall not be greater than the Limit parameter.
pub fn get_access_profile_list<T: transport::Transport>(
    transport: &T,
...
// point will result in a union of the schedules.
pub fn create_access_profile<T: transport::Transport>(
    transport: &T,
...
// will be generated.
pub fn modify_access_profile<T: transport::Transport>(
    transport: &T,
...
pub fn set_access_profile<T: transport::Transport>(
    transport: &T,
...
pub fn delete_access_profile<T: transport::Transport>(
    transport: &T,
