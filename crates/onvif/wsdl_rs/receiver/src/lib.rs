...
#[yaserde(
    prefix = "trv",
    namespaces = { "trv" = "http://www.onvif.org/ver10/receiver/wsdl" }
)]
...
pub struct Capabilities {
    ...
    #[yaserde(attribute = true, rename = "RTP_Multicast")]
    ...
    #[yaserde(attribute = true, rename = "SupportedReceivers")]
    pub supported_receivers: i32,

    // The maximum allowed length for RTSP URIs (Minimum and default value is
    // 128 octet).
    #[yaserde(attribute = true, rename = "MaximumRTSPURILength")]
...
// mandatory.
pub fn get_receivers<T: transport::Transport>(
    transport: &T,
...
pub fn get_receiver<T: transport::Transport>(
    transport: &T,
    request: &GetReceiver,
...
pub fn create_receiver<T: transport::Transport>(
    transport: &T,
...
pub fn delete_receiver<T: transport::Transport>(
    transport: &T,
...
pub fn configure_receiver<T: transport::Transport>(
    transport: &T,
...
// configuration.
// This operation is mandatory.
pub fn set_receiver_mode<T: transport::Transport>(
    transport: &T,
...
// This operation is mandatory.
pub fn get_receiver_state<T: transport::Transport>(
    transport: &T,
