...
#[yaserde(
    prefix = "tsc",
    namespaces = { "tsc" = "http://www.onvif.org/ver10/schedule/wsdl" }
)]
pub struct ServiceCapabilities {
    ...
    #[yaserde(attribute = true, rename = "MaxSchedules")]
    ...
    #[yaserde(attribute = true, rename = "MaxTimePeriodsPerDay")]
    ...
    #[yaserde(attribute = true, rename = "MaxSpecialDayGroups")]
    ...
    #[yaserde(attribute = true, rename = "MaxDaysInSpecialDayGroup")]
    ...
    #[yaserde(attribute = true, rename = "MaxSpecialDaysSchedules")]
    ...
    // are supported.
    #[yaserde(attribute = true, rename = "ExtendedRecurrenceSupported")]
    pub extended_recurrence_supported: bool,

    // If this capability is supported, then the device shall support special
    // days.
    #[yaserde(attribute = true, rename = "SpecialDaysSupported")]
    ...
    #[yaserde(attribute = true, rename = "StateReportingSupported")]
...
// by the given token.
pub fn get_schedule_state<T: transport::Transport>(
    transport: &T,
...
pub fn get_schedule_info<T: transport::Transport>(
    transport: &T,
...
pub fn get_schedule_info_list<T: transport::Transport>(
    transport: &T,
...
// If the number of requested items is greater than MaxLimit, a TooManyItems
// fault shall be returned
pub fn get_schedules<T: transport::Transport>(
    transport: &T,
...
// Please refer Access Control Service Specification for more details.
// The number of items returned shall not be greater the Limit parameter.
pub fn get_schedule_list<T: transport::Transport>(
    transport: &T,
...
pub fn create_schedule<T: transport::Transport>(
    transport: &T,
...
pub fn set_schedule<T: transport::Transport>(
    transport: &T,
    request: &SetSchedule,
...
pub fn modify_schedule<T: transport::Transport>(
    transport: &T,
...
pub fn delete_schedule<T: transport::Transport>(
    transport: &T,
...
// If the number of requested items is greater than MaxLimit, a TooManyItems
// fault shall be returned.
pub fn get_special_day_group_info<T: transport::Transport>(
    transport: &T,
...
pub fn get_special_day_group_info_list<T: transport::Transport>(
    transport: &T,
...
// given token.
pub fn get_special_day_groups<T: transport::Transport>(
    transport: &T,
...
// Please refer Access Control Service Specification for more details.
// The number of items returned shall not be greater the Limit parameter.
pub fn get_special_day_group_list<T: transport::Transport>(
    transport: &T,
...
pub fn create_special_day_group<T: transport::Transport>(
    transport: &T,
...
pub fn set_special_day_group<T: transport::Transport>(
    transport: &T,
...
pub fn modify_special_day_group<T: transport::Transport>(
    transport: &T,
...
// generated.
pub fn delete_special_day_group<T: transport::Transport>(
    transport: &T,
