...
#[yaserde(
    prefix = "tac",
    namespaces = { "tac" = "http://www.onvif.org/ver10/accesscontrol/wsdl" }
)]
...
pub struct AccessPointCapabilities {
    ...
    // are supported.
    #[yaserde(attribute = true, rename = "AccessTaken")]
    ...
    // well.
    #[yaserde(attribute = true, rename = "ExternalAuthorization")]
...
pub fn get_access_point_info<T: transport::Transport>(
    transport: &T,
...
pub fn get_access_point_info_list<T: transport::Transport>(
    transport: &T,
...
// If the number of requested items is greater than MaxLimit, a TooManyItems
// fault shall be returned.
pub fn get_access_points<T: transport::Transport>(
    transport: &T,
...
// The number of items returned shall not be greater than the Limit parameter.
pub fn get_access_point_list<T: transport::Transport>(
    transport: &T,
...
pub fn create_access_point<T: transport::Transport>(
    transport: &T,
...
pub fn set_access_point<T: transport::Transport>(
    transport: &T,
...
// If no token was specified in the request, the device shall return InvalidArgs
// as a generic fault code.
pub fn modify_access_point<T: transport::Transport>(
    transport: &T,
...
// If no token was specified in the request, the device shall return InvalidArgs
// as a generic fault code.
pub fn delete_access_point<T: transport::Transport>(
    transport: &T,
...
pub fn set_access_point_authentication_profile<T: transport::Transport>(
    transport: &T,
...
// default behavior.
pub fn delete_access_point_authentication_profile<T: transport::Transport>(
    transport: &T,
...
// If the number of requested items is greater than MaxLimit, a TooManyItems
// fault shall be returned.
pub fn get_area_info<T: transport::Transport>(
    transport: &T,
    request: &GetAreaInfo,
...
// The reference shall be valid for retrieving the next set of data.
// The number of items returned shall not be greater than the Limit parameter.
pub fn get_area_info_list<T: transport::Transport>(
    transport: &T,
...
// If the number of requested items is greater than MaxLimit, a TooManyItems
// fault shall be returned.
pub fn get_areas<T: transport::Transport>(
    transport: &T,
    request: &GetAreas,
...
// The reference shall be valid for retrieving the next set of data.
// The number of items returned shall not be greater than the Limit parameter.
pub fn get_area_list<T: transport::Transport>(
    transport: &T,
    request: &GetAreaList,
...
pub fn create_area<T: transport::Transport>(
    transport: &T,
    request: &CreateArea,
...
pub fn set_area<T: transport::Transport>(
    transport: &T,
    request: &SetArea,
...
// If no token was specified in the request, the device shall return InvalidArgs
// as a generic fault code.
pub fn modify_area<T: transport::Transport>(
    transport: &T,
    request: &ModifyArea,
...
// If no token was specified in the request, the device shall return InvalidArgs
// as a generic fault code.
pub fn delete_area<T: transport::Transport>(
    transport: &T,
    request: &DeleteArea,
...
pub fn get_access_point_state<T: transport::Transport>(
    transport: &T,
...
// implement this command.
pub fn enable_access_point<T: transport::Transport>(
    transport: &T,
...
// DisableAccessPoint capability for a particular access point instance shall
// implement this command.
pub fn disable_access_point<T: transport::Transport>(
    transport: &T,
...
pub fn external_authorization<T: transport::Transport>(
    transport: &T,
