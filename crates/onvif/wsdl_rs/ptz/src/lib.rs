...
#[yaserde(
    prefix = "tptz",
    namespaces = { "tptz" = "http://www.onvif.org/ver20/ptz/wsdl" }
)]
...
pub fn get_nodes<T: transport::Transport>(
    transport: &T,
    request: &GetNodes,
...
// token or a name.
pub fn get_node<T: transport::Transport>(
    transport: &T,
    request: &GetNode,
...
// token or name.
pub fn get_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn get_configurations<T: transport::Transport>(
    transport: &T,
...
pub fn set_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn get_configuration_options<T: transport::Transport>(
    transport: &T,
...
pub fn get_presets<T: transport::Transport>(
    transport: &T,
    request: &GetPresets,
...
pub fn set_preset<T: transport::Transport>(
    transport: &T,
    request: &SetPreset,
...
// selected profile.
pub fn remove_preset<T: transport::Transport>(
    transport: &T,
...
pub fn goto_preset<T: transport::Transport>(
    transport: &T,
    request: &GotoPreset,
...
pub fn goto_home_position<T: transport::Transport>(
    transport: &T,
...
pub fn set_home_position<T: transport::Transport>(
    transport: &T,
...
pub fn continuous_move<T: transport::Transport>(
    transport: &T,
...
pub fn relative_move<T: transport::Transport>(
    transport: &T,
...
// selected profile.
pub fn get_status<T: transport::Transport>(
    transport: &T,
    request: &GetStatus,
...
pub fn absolute_move<T: transport::Transport>(
    transport: &T,
...
pub fn geo_move<T: transport::Transport>(
    transport: &T,
    request: &GeoMove,
...
pub fn stop<T: transport::Transport>(
    transport: &T,
    request: &Stop,
...
pub fn get_preset_tours<T: transport::Transport>(
    transport: &T,
...
// profile.
pub fn get_preset_tour<T: transport::Transport>(
    transport: &T,
...
pub fn get_preset_tour_options<T: transport::Transport>(
    transport: &T,
...
pub fn create_preset_tour<T: transport::Transport>(
    transport: &T,
...
pub fn modify_preset_tour<T: transport::Transport>(
    transport: &T,
...
// profile.
pub fn operate_preset_tour<T: transport::Transport>(
    transport: &T,
...
pub fn remove_preset_tour<T: transport::Transport>(
    transport: &T,
...
pub fn get_compatible_configurations<T: transport::Transport>(
    transport: &T,
