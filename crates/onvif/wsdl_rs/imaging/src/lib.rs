...
#[yaserde(
    prefix = "timg",
    namespaces = { "timg" = "http://www.onvif.org/ver20/imaging/wsdl" }
)]
...
pub fn get_imaging_settings<T: transport::Transport>(
    transport: &T,
...
pub fn set_imaging_settings<T: transport::Transport>(
    transport: &T,
...
pub fn get_options<T: transport::Transport>(
    transport: &T,
    request: &GetOptions,
...
// functional.
pub fn _move<T: transport::Transport>(
    transport: &T,
    request: &Move,
...
pub fn get_move_options<T: transport::Transport>(
    transport: &T,
...
// Video Source.
pub fn get_current_preset<T: transport::Transport>(
    transport: &T,
...
// Imaging Preset.
pub fn set_current_preset<T: transport::Transport>(
    transport: &T,
