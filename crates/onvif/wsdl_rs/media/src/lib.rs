...
#[yaserde(
    prefix = "trt",
    namespaces = { "trt" = "http://www.onvif.org/ver10/media/wsdl" }
)]
...
pub struct ProfileCapabilities {
    ...
    #[yaserde(attribute = true, rename = "MaximumNumberOfProfiles")]
...
pub struct VideoSourceMode {
    ...
    #[yaserde(attribute = true, rename = "token")]
...
pub fn get_video_sources<T: transport::Transport>(
    transport: &T,
...
pub fn get_audio_sources<T: transport::Transport>(
    transport: &T,
...
pub fn get_audio_outputs<T: transport::Transport>(
    transport: &T,
...
// returned Profile.
pub fn create_profile<T: transport::Transport>(
    transport: &T,
...
// GetProfile command.
pub fn get_profile<T: transport::Transport>(
    transport: &T,
    request: &GetProfile,
...
pub fn get_profiles<T: transport::Transport>(
    transport: &T,
    request: &GetProfiles,
...
pub fn add_video_encoder_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn remove_video_encoder_configuration<T: transport::Transport>(
    transport: &T,
...
// configuration exists in the media profile, it will be replaced. The change
// shall be persistent.
pub fn add_video_source_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn remove_video_source_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn add_audio_encoder_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn remove_audio_encoder_configuration<T: transport::Transport>(
    transport: &T,
...
// configuration exists in the media profile, it will be replaced. The change
// shall be persistent.
pub fn add_audio_source_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn remove_audio_source_configuration<T: transport::Transport>(
    transport: &T,
...
// for controlling
// PTZ movement.
pub fn add_ptz_configuration<T: transport::Transport>(
    transport: &T,
...
// shall be persistent.
pub fn remove_ptz_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn add_video_analytics_configuration<T: transport::Transport>(
    transport: &T,
...
// The removal shall be persistent.
pub fn remove_video_analytics_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn add_metadata_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn remove_metadata_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn add_audio_output_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn remove_audio_output_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn add_audio_decoder_configuration<T: transport::Transport>(
    transport: &T,
...
// the operation has no effect. The removal shall be persistent.
pub fn remove_audio_decoder_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn delete_profile<T: transport::Transport>(
    transport: &T,
...
pub fn get_video_source_configurations<T: transport::Transport>(
    transport: &T,
...
pub fn get_video_encoder_configurations<T: transport::Transport>(
    transport: &T,
...
// to use the command.
pub fn get_audio_source_configurations<T: transport::Transport>(
    transport: &T,
...
pub fn get_audio_encoder_configurations<T: transport::Transport>(
    transport: &T,
...
pub fn get_video_analytics_configurations<T: transport::Transport>(
    transport: &T,
...
pub fn get_metadata_configurations<T: transport::Transport>(
    transport: &T,
...
// command.
pub fn get_audio_output_configurations<T: transport::Transport>(
    transport: &T,
...
// order to
// use this command.
pub fn get_audio_decoder_configurations<T: transport::Transport>(
    transport: &T,
...
pub fn get_video_source_configuration<T: transport::Transport>(
    transport: &T,
...
// command.
pub fn get_video_encoder_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn get_audio_source_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn get_audio_encoder_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn get_video_analytics_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn get_metadata_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn get_audio_output_configuration<T: transport::Transport>(
    transport: &T,
...
// command.
pub fn get_audio_decoder_configuration<T: transport::Transport>(
    transport: &T,
...
// device.
pub fn get_compatible_video_encoder_configurations<T: transport::Transport>(
    transport: &T,
...
// device.
pub fn get_compatible_video_source_configurations<T: transport::Transport>(
    transport: &T,
...
pub fn get_compatible_audio_encoder_configurations<T: transport::Transport>(
    transport: &T,
...
pub fn get_compatible_audio_source_configurations<T: transport::Transport>(
    transport: &T,
...
// device.
pub fn get_compatible_video_analytics_configurations<T: transport::Transport>(
    transport: &T,
...
// depending on the capabilities, configurations and settings in the device.
pub fn get_compatible_metadata_configurations<T: transport::Transport>(
    transport: &T,
...
pub fn get_compatible_audio_output_configurations<T: transport::Transport>(
    transport: &T,
...
pub fn get_compatible_audio_decoder_configurations<T: transport::Transport>(
    transport: &T,
...
// specification.
pub fn set_video_source_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn set_video_encoder_configuration<T: transport::Transport>(
    transport: &T,
...
// specification.
pub fn set_audio_source_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn set_audio_encoder_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn set_video_analytics_configuration<T: transport::Transport>(
    transport: &T,
...
// changing a
// running stream are out of scope for this specification.
pub fn set_metadata_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn set_audio_output_configuration<T: transport::Transport>(
    transport: &T,
...
// flag indicates if
// the changes shall remain after reboot of the device.
pub fn set_audio_decoder_configuration<T: transport::Transport>(
    transport: &T,
...
// be compatible with
// that media profile.
pub fn get_video_source_configuration_options<T: transport::Transport>(
    transport: &T,
...
pub fn get_video_encoder_configuration_options<T: transport::Transport>(
    transport: &T,
...
// be compatible with
// that media profile.
pub fn get_audio_source_configuration_options<T: transport::Transport>(
    transport: &T,
...
// reconfigured.
pub fn get_audio_encoder_configuration_options<T: transport::Transport>(
    transport: &T,
...
pub fn get_metadata_configuration_options<T: transport::Transport>(
    transport: &T,
...
pub fn get_audio_output_configuration_options<T: transport::Transport>(
    transport: &T,
...
// configuration of a
// device.
pub fn get_audio_decoder_configuration_options<T: transport::Transport>(
    transport: &T,
...
// Source
// Configuration.
pub fn get_guaranteed_number_of_video_encoder_instances<T: transport::Transport>(
    transport: &T,
...
pub fn get_stream_uri<T: transport::Transport>(
    transport: &T,
...
// respectively.
pub fn start_multicast_streaming<T: transport::Transport>(
    transport: &T,
...
// device
pub fn stop_multicast_streaming<T: transport::Transport>(
    transport: &T,
...
pub fn set_synchronization_point<T: transport::Transport>(
    transport: &T,
...
// GetSnapshotUri.
pub fn get_snapshot_uri<T: transport::Transport>(
    transport: &T,
...
pub fn get_video_source_modes<T: transport::Transport>(
    transport: &T,
...
pub fn set_video_source_mode<T: transport::Transport>(
    transport: &T,
...
// Get the OSDs.
pub fn get_os_ds<T: transport::Transport>(
    transport: &T,
    request: &GetOSDs,
...
// Get the OSD.
pub fn get_osd<T: transport::Transport>(
    transport: &T,
    request: &GetOSD,
...
// Get the OSD Options.
pub fn get_osd_options<T: transport::Transport>(
    transport: &T,
...
// Set the OSD
pub fn set_osd<T: transport::Transport>(
    transport: &T,
    request: &SetOSD,
...
// Create the OSD.
pub fn create_osd<T: transport::Transport>(
    transport: &T,
    request: &CreateOSD,
...
// Delete the OSD.
pub fn delete_osd<T: transport::Transport>(
    transport: &T,
    request: &DeleteOSD,
