...
#[yaserde(
    prefix = "tmd",
    namespaces = { "tmd" = "http://www.onvif.org/ver10/deviceIO/wsdl" }
)]
...
pub fn get_relay_output_options<T: transport::Transport>(
    transport: &T,
...
pub fn get_video_outputs<T: transport::Transport>(
    transport: &T,
...
// this command.
pub fn get_video_output_configuration<T: transport::Transport>(
    transport: &T,
...
// this command.
pub fn set_video_output_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn get_video_output_configuration_options<T: transport::Transport>(
    transport: &T,
...
pub fn get_digital_inputs<T: transport::Transport>(
    transport: &T,
...
pub fn get_digital_input_configuration_options<T: transport::Transport>(
    transport: &T,
...
pub fn set_digital_input_configurations<T: transport::Transport>(
    transport: &T,
...
pub fn get_serial_ports<T: transport::Transport>(
    transport: &T,
...
pub fn get_serial_port_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn set_serial_port_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn get_serial_port_configuration_options<T: transport::Transport>(
    transport: &T,
...
pub fn send_receive_serial_command<T: transport::Transport>(
    transport: &T,
