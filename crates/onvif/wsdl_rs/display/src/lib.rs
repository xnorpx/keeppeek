...
#[yaserde(
    prefix = "tls",
    namespaces = { "tls" = "http://www.onvif.org/ver10/display/wsdl" }
)]
...
pub struct Capabilities {
    ...
    #[yaserde(attribute = true, rename = "FixedLayout")]
...
pub fn get_layout<T: transport::Transport>(
    transport: &T,
    request: &GetLayout,
...
// PaneConfigurations and
// their associated display areas.
pub fn set_layout<T: transport::Transport>(
    transport: &T,
    request: &SetLayout,
...
pub fn get_display_options<T: transport::Transport>(
    transport: &T,
...
// session will
// not be established.
pub fn get_pane_configurations<T: transport::Transport>(
    transport: &T,
...
pub fn get_pane_configuration<T: transport::Transport>(
    transport: &T,
...
// unchanged.
// Use
pub fn set_pane_configurations<T: transport::Transport>(
    transport: &T,
...
pub fn set_pane_configuration<T: transport::Transport>(
    transport: &T,
...
// for a display area.
pub fn create_pane_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn delete_pane_configuration<T: transport::Transport>(
    transport: &T,
