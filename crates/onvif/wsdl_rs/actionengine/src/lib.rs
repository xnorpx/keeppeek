...
#[yaserde(
    prefix = "tae",
    namespaces = { "tae" = "http://www.onvif.org/ver10/actionengine/wsdl" }
)]
...
pub struct Smtpconfig {
    ...
    #[yaserde(attribute = true, rename = "portNo")]
...
pub struct HostAddress {
    ...
    #[yaserde(attribute = true, rename = "formatType")]
...
pub struct EmailBodyTextConfiguration {
    ...
    #[yaserde(attribute = true, rename = "includeEvent")]
...
pub struct HttpDestinationConfiguration {
    ...
    #[yaserde(attribute = true, rename = "uri")]
    pub uri: Option<String>,

    // HTTP/HTTPS protocol selection (default is http)
    #[yaserde(attribute = true, rename = "protocol")]
...
pub struct PostBodyConfiguration {
    #[yaserde(attribute = true, rename = "formData")]
    ...
    #[yaserde(attribute = true, rename = "includeMedia")]
...
pub struct FtpFileNameConfigurations {
    // Name of file
    #[yaserde(attribute = true, rename = "file_name")]
    pub file_name: Option<String>,

    // Suffix of file
    #[yaserde(attribute = true, rename = "suffix")]
...
pub fn get_supported_actions<T: transport::Transport>(
    transport: &T,
...
pub fn get_actions<T: transport::Transport>(
    transport: &T,
    request: &GetActions,
...
pub fn create_actions<T: transport::Transport>(
    transport: &T,
...
pub fn delete_actions<T: transport::Transport>(
    transport: &T,
...
pub fn modify_actions<T: transport::Transport>(
    transport: &T,
...
pub fn get_action_triggers<T: transport::Transport>(
    transport: &T,
...
// provider responds with a fault message.
pub fn create_action_triggers<T: transport::Transport>(
    transport: &T,
...
// provider responds with a fault message.
pub fn delete_action_triggers<T: transport::Transport>(
    transport: &T,
...
pub fn modify_action_triggers<T: transport::Transport>(
    transport: &T,
