...
pub struct Capabilities2 {
    ...
    #[yaserde(attribute = true, rename = "Mask")]
    ...
    #[yaserde(attribute = true, rename = "SourceMask")]
...
pub struct ProfileCapabilities {
    ...
    #[yaserde(attribute = true, rename = "ConfigurationsSupported")]
...
pub struct StreamingCapabilities {
    ...
    #[yaserde(attribute = true, rename = "RTSPStreaming")]
...
pub struct MaskOptions {
    ...
    // shape.
    #[yaserde(attribute = true, rename = "RectangleOnly")]
    ...
    #[yaserde(attribute = true, rename = "SingleColorOnly")]
...
pub fn add_configuration<T: transport::Transport>(
    transport: &T,
...
// shall be ignored.
pub fn remove_configuration<T: transport::Transport>(
    transport: &T,
...
// compatible with the profile. If a configuration token is provided only a
// single configuration will be returned.
pub fn get_analytics_configurations<T: transport::Transport>(
    transport: &T,
...
// Source
// Configuration.
pub fn get_video_encoder_instances<T: transport::Transport>(
    transport: &T,
...
pub fn get_masks<T: transport::Transport>(
    transport: &T,
    request: &GetMasks,
...
pub fn get_mask_options<T: transport::Transport>(
    transport: &T,
...
// Set the Mask
pub fn set_mask<T: transport::Transport>(
    transport: &T,
    request: &SetMask,
...
// Create the Mask.
pub fn create_mask<T: transport::Transport>(
    transport: &T,
    request: &CreateMask,
...
// Delete the Mask.
pub fn delete_mask<T: transport::Transport>(
    transport: &T,
    request: &DeleteMask,
