...
#[yaserde(
    prefix = "tse",
    namespaces = { "tse" = "http://www.onvif.org/ver10/search/wsdl" }
)]
...
// search service.
pub fn get_recording_summary<T: transport::Transport>(
    transport: &T,
...
// service.
pub fn get_recording_information<T: transport::Transport>(
    transport: &T,
...
pub fn get_media_attributes<T: transport::Transport>(
    transport: &T,
...
pub fn find_recordings<T: transport::Transport>(
    transport: &T,
...
// method.
pub fn get_recording_search_results<T: transport::Transport>(
    transport: &T,
...
// returned from
// this request.
pub fn find_events<T: transport::Transport>(
    transport: &T,
    request: &FindEvents,
...
pub fn get_event_search_results<T: transport::Transport>(
    transport: &T,
...
// returned from
// this request.
pub fn find_ptz_position<T: transport::Transport>(
    transport: &T,
...
pub fn get_ptz_position_search_results<T: transport::Transport>(
    transport: &T,
...
pub fn get_search_state<T: transport::Transport>(
    transport: &T,
...
// implementing the
// recording search service.
pub fn end_search<T: transport::Transport>(
    transport: &T,
    request: &EndSearch,
...
// from this
// request.
pub fn find_metadata<T: transport::Transport>(
    transport: &T,
...
// response shall not
// contain more than MaxResults results.
pub fn get_metadata_search_results<T: transport::Transport>(
    transport: &T,
