...
#[yaserde(
    prefix = "tcr",
    namespaces = { "tcr" = "http://www.onvif.org/ver10/credential/wsdl" }
)]
pub struct ServiceCapabilities {
    ...
    #[yaserde(attribute = true, rename = "ResetAntipassbackSupported")]
    ...
    // true.
    #[yaserde(attribute = true, rename = "ClientSuppliedTokenSupported")]
    ...
    // “PT5M”).
    #[yaserde(attribute = true, rename = "DefaultCredentialSuspensionDuration")]
...
// the device.
pub fn get_supported_format_types<T: transport::Transport>(
    transport: &T,
...
pub fn get_credential_info<T: transport::Transport>(
    transport: &T,
...
pub fn get_credential_info_list<T: transport::Transport>(
    transport: &T,
...
// If the number of requested items is greater than MaxLimit, a TooManyItems
// fault shall be returned.
pub fn get_credentials<T: transport::Transport>(
    transport: &T,
...
pub fn get_credential_list<T: transport::Transport>(
    transport: &T,
...
pub fn create_credential<T: transport::Transport>(
    transport: &T,
...
pub fn set_credential<T: transport::Transport>(
    transport: &T,
...
// specified entities.
pub fn modify_credential<T: transport::Transport>(
    transport: &T,
...
pub fn delete_credential<T: transport::Transport>(
    transport: &T,
...
pub fn get_credential_state<T: transport::Transport>(
    transport: &T,
...
pub fn enable_credential<T: transport::Transport>(
    transport: &T,
...
pub fn disable_credential<T: transport::Transport>(
    transport: &T,
...
// credential.
pub fn reset_antipassback_violation<T: transport::Transport>(
    transport: &T,
...
pub fn get_credential_identifiers<T: transport::Transport>(
    transport: &T,
...
pub fn set_credential_identifier<T: transport::Transport>(
    transport: &T,
...
// response.
pub fn delete_credential_identifier<T: transport::Transport>(
    transport: &T,
...
pub fn get_credential_access_profiles<T: transport::Transport>(
    transport: &T,
...
// added.
pub fn set_credential_access_profiles<T: transport::Transport>(
    transport: &T,
...
pub fn delete_credential_access_profiles<T: transport::Transport>(
    transport: &T,
