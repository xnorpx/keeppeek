...
#[yaserde(
    prefix = "tas",
    namespaces = { "tas" = "http://www.onvif.org/ver10/advancedsecurity/wsdl" }
)]
...
pub struct Dot1XCapabilities {
    ...
    // simultaneously.
    #[yaserde(attribute = true, rename = "MaximumNumberOfDot1XConfigurations")]
    ...
    #[yaserde(attribute = true, rename = "Dot1XMethods")]
...
pub struct Dot1XStage {
    ...
    #[yaserde(attribute = true, rename = "Method")]
    pub method: String,
}
...
pub struct KeystoreCapabilities {
    ...
    #[yaserde(attribute = true, rename = "MaximumNumberOfCertificationPaths")]
    ...
    #[yaserde(attribute = true, rename = "PKCS10ExternalCertificationWithRSA")]
    ...
    #[yaserde(attribute = true, rename = "PKCS12CertificateWithRSAPrivateKeyUpload")]
    ...
    // device.
    #[yaserde(attribute = true, rename = "PasswordBasedEncryptionAlgorithms")]
    ...
    // device.
    #[yaserde(attribute = true, rename = "PasswordBasedMACAlgorithms")]
    ...
    // simultaneously.
    #[yaserde(attribute = true, rename = "MaximumNumberOfCRLs")]
    ...
    #[yaserde(attribute = true, rename = "EnforceTLSWebClientAuthExtKeyUsage")]
    ...
    // its own unique key.
    #[yaserde(attribute = true, rename = "NoPrivateKeySharing")]
...
pub struct TlsserverCapabilities {
    ...
    #[yaserde(attribute = true, rename = "MaximumNumberOfTLSCertificationPaths")]
    ...
    #[yaserde(attribute = true, rename = "TLSClientAuthSupported")]
...
// (to be written)
pub fn add_dot_1x_configuration<T: transport::Transport>(
    transport: &T,
...
// (to be written)
pub fn get_all_dot_1x_configurations<T: transport::Transport>(
    transport: &T,
...
// (to be written)
pub fn set_network_interface_dot_1x_configuration<T: transport::Transport>(
    transport: &T,
...
// (to be written)
pub fn get_network_interface_dot_1x_configuration<T: transport::Transport>(
    transport: &T,
...
// (to be written)
pub fn delete_network_interface_dot_1x_configuration<T: transport::Transport>(
    transport: &T,
...
pub fn create_rsa_key_pair<T: transport::Transport>(
    transport: &T,
...
// [RFC 5958, RFC 5959].
pub fn upload_key_pair_in_pkcs8<T: transport::Transport>(
    transport: &T,
...
pub fn upload_certificate_with_private_key_in_pkcs12<T: transport::Transport>(
    transport: &T,
...
pub fn get_key_status<T: transport::Transport>(
    transport: &T,
...
pub fn get_private_key_status<T: transport::Transport>(
    transport: &T,
...
// device’s keystore.
pub fn get_all_keys<T: transport::Transport>(
    transport: &T,
    request: &GetAllKeys,
...
pub fn delete_key<T: transport::Transport>(
    transport: &T,
    request: &DeleteKey,
...
pub fn create_pkcs10csr<T: transport::Transport>(
    transport: &T,
...
pub fn create_self_signed_certificate<T: transport::Transport>(
    transport: &T,
...
pub fn upload_certificate<T: transport::Transport>(
    transport: &T,
...
pub fn get_certificate<T: transport::Transport>(
    transport: &T,
...
// device’s keystore.
pub fn get_all_certificates<T: transport::Transport>(
    transport: &T,
...
pub fn delete_certificate<T: transport::Transport>(
    transport: &T,
...
pub fn create_certification_path<T: transport::Transport>(
    transport: &T,
...
// keystore.
pub fn get_certification_path<T: transport::Transport>(
    transport: &T,
...
pub fn get_all_certification_paths<T: transport::Transport>(
    transport: &T,
...
pub fn delete_certification_path<T: transport::Transport>(
    transport: &T,
...
pub fn upload_passphrase<T: transport::Transport>(
    transport: &T,
...
// list.
pub fn get_all_passphrases<T: transport::Transport>(
    transport: &T,
...
pub fn delete_passphrase<T: transport::Transport>(
    transport: &T,
...
pub fn upload_crl<T: transport::Transport>(
    transport: &T,
    request: &UploadCRL,
...
// fault.
pub fn get_crl<T: transport::Transport>(
    transport: &T,
    request: &GetCRL,
...
pub fn get_all_cr_ls<T: transport::Transport>(
    transport: &T,
    request: &GetAllCRLs,
...
// to other CRLs.
pub fn delete_crl<T: transport::Transport>(
    transport: &T,
    request: &DeleteCRL,
...
// shall not create a certification path validation policy.
pub fn create_cert_path_validation_policy<T: transport::Transport>(
    transport: &T,
...
pub fn get_cert_path_validation_policy<T: transport::Transport>(
    transport: &T,
...
pub fn get_all_cert_path_validation_policies<T: transport::Transport>(
    transport: &T,
...
pub fn delete_cert_path_validation_policy<T: transport::Transport>(
    transport: &T,
...
pub fn add_server_certificate_assignment<T: transport::Transport>(
    transport: &T,
...
pub fn remove_server_certificate_assignment<T: transport::Transport>(
    transport: &T,
...
pub fn replace_server_certificate_assignment<T: transport::Transport>(
    transport: &T,
...
pub fn set_enabled_tls_versions<T: transport::Transport>(
    transport: &T,
...
// the device.
pub fn get_enabled_tls_versions<T: transport::Transport>(
    transport: &T,
...
pub fn get_assigned_server_certificates<T: transport::Transport>(
    transport: &T,
...
pub fn set_client_authentication_required<T: transport::Transport>(
    transport: &T,
...
pub fn get_client_authentication_required<T: transport::Transport>(
    transport: &T,
...
pub fn add_cert_path_validation_policy_assignment<T: transport::Transport>(
    transport: &T,
...
pub fn remove_cert_path_validation_policy_assignment<T: transport::Transport>(
    transport: &T,
...
// server.
pub fn replace_cert_path_validation_policy_assignment<T: transport::Transport>(
    transport: &T,
...
pub fn get_assigned_cert_path_validation_policies<T: transport::Transport>(
    transport: &T,
