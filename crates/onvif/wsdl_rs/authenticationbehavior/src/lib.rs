...
#[yaserde(
    prefix = "tab",
    namespaces = { "tab" = "http://www.onvif.org/ver10/authenticationbehavior/wsdl" }
)]
pub struct ServiceCapabilities {
    ...
    #[yaserde(attribute = true, rename = "MaxAuthenticationProfiles")]
    ...
    // by the device.
    #[yaserde(attribute = true, rename = "MaxPoliciesPerAuthenticationProfile")]
    ...
    // security level.
    #[yaserde(attribute = true, rename = "MaxSecurityLevels")]
    pub max_security_levels: pt::PositiveInteger,

    // Indicates the maximum number of recognition groups per security level
    // supported by the
    // device.
    #[yaserde(attribute = true, rename = "MaxRecognitionGroupsPerSecurityLevel")]
    ...
    // supported by the
    // device.
    #[yaserde(attribute = true, rename = "MaxRecognitionMethodsPerRecognitionGroup")]
    ...
    #[yaserde(attribute = true, rename = "SupportedAuthenticationModes")]
...
// case.
pub fn get_authentication_profile_info<T: transport::Transport>(
    transport: &T,
...
pub fn get_authentication_profile_info_list<T: transport::Transport>(
    transport: &T,
...
pub fn get_authentication_profiles<T: transport::Transport>(
    transport: &T,
...
pub fn get_authentication_profile_list<T: transport::Transport>(
    transport: &T,
...
// fault code.
pub fn create_authentication_profile<T: transport::Transport>(
    transport: &T,
...
// command.
pub fn set_authentication_profile<T: transport::Transport>(
    transport: &T,
...
pub fn modify_authentication_profile<T: transport::Transport>(
    transport: &T,
...
pub fn delete_authentication_profile<T: transport::Transport>(
    transport: &T,
...
// matching the specified tokens. The device shall not return a fault in this
// case.
pub fn get_security_level_info<T: transport::Transport>(
    transport: &T,
...
// Service Specification for more details.
// The number of items returned shall not be greater than Limit parameter.
pub fn get_security_level_info_list<T: transport::Transport>(
    transport: &T,
...
// list if there are no items
// matching specified tokens. The device shall not return a fault in this case.
pub fn get_security_levels<T: transport::Transport>(
    transport: &T,
...
// Service Specification for more details.
// The number of items returned shall not be greater the Limit parameter.
pub fn get_security_level_list<T: transport::Transport>(
    transport: &T,
...
// InvalidArgVal as a generic
// fault code.
pub fn create_security_level<T: transport::Transport>(
    transport: &T,
...
// shall implement this
// command.
pub fn set_security_level<T: transport::Transport>(
    transport: &T,
...
pub fn modify_security_level<T: transport::Transport>(
    transport: &T,
...
// and consequently a ReferenceInUse fault shall be generated.
pub fn delete_security_level<T: transport::Transport>(
    transport: &T,
