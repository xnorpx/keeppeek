...
impl TryFrom<&'_ [u8]> for Method {
    ...
    fn try_from(v: &'_ [u8]) -> Result<Self, InvalidMethodError> {
...
impl TryFrom<Vec<u8>> for Method {
    type Error = InvalidMethodError;
    fn try_from(v: Vec<u8>) -> Result<Self, InvalidMethodError> {
        if !is_valid_token(&v) {
...
impl TryFrom<&'_ str> for Method {
    type Error = InvalidMethodError;
    fn try_from(v: &'_ str) -> Result<Self, InvalidMethodError> {
...
impl TryFrom<String> for Method {
    type Error = InvalidMethodError;
    fn try_from(v: String) -> Result<Self, InvalidMethodError> {
...
impl StatusCode {
    ...
    pub const SESSION_NOT_FOUND: Self = Self(454);
...
impl TryFrom<&'_ [u8]> for HeaderName {
    ...
    fn try_from(v: &'_ [u8]) -> Result<Self, InvalidHeaderNameError> {
        Self::try_from(v.to_owned())
    }
}
...
impl TryFrom<Vec<u8>> for HeaderName {
    type Error = InvalidHeaderNameError;
    fn try_from(v: Vec<u8>) -> Result<Self, InvalidHeaderNameError> {
        if !is_valid_token(&v) {
...
impl TryFrom<&'_ str> for HeaderName {
    type Error = InvalidHeaderNameError;
    fn try_from(v: &'_ str) -> Result<Self, InvalidHeaderNameError> {
        Self::try_from(v.as_bytes().to_owned())
    }
}
...
impl TryFrom<String> for HeaderName {
    type Error = InvalidHeaderNameError;
    fn try_from(v: String) -> Result<Self, InvalidHeaderNameError> {
        if !is_valid_token(v.as_bytes()) {
...
impl TryFrom<String> for HeaderValue {
    ...
    fn try_from(v: String) -> Result<Self, InvalidHeaderValueError> {
...
impl TryFrom<&str> for HeaderValue {
    type Error = InvalidHeaderValueError;
    fn try_from(v: &str) -> Result<Self, InvalidHeaderValueError> {
        if !is_valid_header_value(v.as_bytes()) {
            return Err(InvalidHeaderValueError);
        }
        Ok(Self(v.to_owned()))
...
impl TryFrom<Vec<u8>> for HeaderValue {
    type Error = InvalidHeaderValueError;
    fn try_from(v: Vec<u8>) -> Result<Self, InvalidHeaderValueError> {
...
impl OwnedMessage {
    ...
    pub fn headers_mut(&mut self) -> &mut Headers {
        match self {
            Self::Request { head, .. } => &mut head.headers,
            _ => panic!("not a request"),
        }
    }
