...
impl VideoParameters {
    ...
    /// ISO/IEC 14496-12).
    pub const fn mp4_sample_entry(&self) -> VideoSampleEntryBuilder<'_> {
    ...
    /// of `(40, 33)`.
    pub const fn pixel_aspect_ratio(&self) -> Option<(u32, u32)> {
    ...
    pub const fn codec_params(&self) -> &VideoParametersCodec {
        &self.codec
    }
...
impl VideoParametersCodec {
    const fn visual_sample_entry_box_type(&self) -> [u8; 4] {
        match self {
            Self::H264 { .. } => *b"avc1",
            #[cfg(feature = "h265")]
            Self::H265 { .. } => *b"hvc1",
...
impl VideoSampleEntryBuilder<'_> {
    ...
    #[inline]
    pub const fn with_aspect_ratio(self, aspect_ratio: (u16, u16)) -> Self {
        Self {
...
impl AudioParameters {
    ...
    pub const fn frame_length(&self) -> Option<NonZeroU32> {
        self.frame_length
    }
    ...
    pub const fn mp4_sample_entry(&self) -> AudioSampleEntryBuilder<'_> {
...
impl AudioFrame {
    #[inline]
    pub const fn ctx(&self) -> &crate::PacketContext {
        &self.ctx
    }

    #[inline]
    pub const fn stream_id(&self) -> usize {
        self.stream_id
    }

    #[inline]
    pub const fn timestamp(&self) -> crate::Timestamp {
        self.timestamp
    }

    #[inline]
    pub const fn frame_length(&self) -> NonZeroU32 {
        self.frame_length
    }
...
impl VideoFrame {
    ...
    #[inline]
    pub const fn has_new_parameters(&self) -> bool {
    ...
    #[inline]
    pub const fn start_ctx(&self) -> &crate::PacketContext {
        &self.start_ctx
    }

    #[inline]
    pub const fn end_ctx(&self) -> &crate::PacketContext {
        &self.end_ctx
    }
