...
impl UnitType {
    pub const fn unit_type_class(self) -> UnitTypeClass {
        match self {
            Self::TrailN
            | Self::TrailR
            | Self::TsaN
            ...
            | Self::RsvVcl29
            | Self::RsvVcl30
            | Self::RsvVcl31 => UnitTypeClass::Vcl { intra_coded: false },
            Self::IdrWRadl | Self::IdrNLp => UnitTypeClass::Vcl { intra_coded: true },
...
impl TryFrom<u8> for UnitType {
    ...
    fn try_from(value: u8) -> Result<Self, Self::Error> {
        if value > 63 {
            return Err(Error(format!("NAL 0x{value:02X} is out of range")));
        }
...
impl Sps {
    ...
    pub(crate) const fn general_level_idc(&self) -> u8 {
        self.profile_tier_level.general_level_idc
    }

    /// The maximum sub layers, in the range [1, 7].
    pub const fn max_sub_layers(&self) -> u8 {
        self.sps_max_sub_layers_minus1 + 1
    }

    pub const fn temporal_id_nesting_flag(&self) -> bool {
        self.sps_temporal_id_nesting_flag
    }

    pub const fn vui(&self) -> Option<&VuiParameters> {
        self.vui.as_ref()
    }
    ...
    pub(crate) const fn chroma_format_idc(&self) -> u8 {
        self.chroma_format_idc
    }

    pub(crate) const fn bit_depth_luma_minus8(&self) -> u8 {
        self.bit_depth_luma_minus8
    }

    pub(crate) const fn bit_depth_chroma_minus8(&self) -> u8 {
...
impl Profile {
    ...
    #[inline]
    pub const fn general_profile_compatibility_flags(&self) -> u32 {
...
impl Pps {
    ...
    pub(crate) const fn entropy_coding_sync_enabled_flag(&self) -> bool {
        self.entropy_coding_sync_enabled_flag
    }

    pub(crate) const fn tiles_enabled_flag(&self) -> bool {
...
impl ShortTermRefPicSet {
    pub fn from_bits<R: BitRead>(r: &mut R, prev: Option<&Self>) -> Result<Self, Error> {
...
impl AspectRatioInfo {
    ...
    pub const fn get(self) -> Option<(u16, u16)> {
        match self {
            Self::Unspecified => None,
            Self::Ratio1_1 => Some((1, 1)),
            Self::Ratio12_11 => Some((12, 11)),
            Self::Ratio10_11 => Some((10, 11)),
            Self::Ratio16_11 => Some((16, 11)),
            Self::Ratio40_33 => Some((40, 33)),
            Self::Ratio24_11 => Some((24, 11)),
            Self::Ratio20_11 => Some((20, 11)),
            Self::Ratio32_11 => Some((32, 11)),
            Self::Ratio80_33 => Some((80, 33)),
            Self::Ratio18_11 => Some((18, 11)),
            Self::Ratio15_11 => Some((15, 11)),
            Self::Ratio64_33 => Some((64, 33)),
            Self::Ratio160_99 => Some((160, 99)),
            Self::Ratio4_3 => Some((4, 3)),
            Self::Ratio3_2 => Some((3, 2)),
            Self::Ratio2_1 => Some((2, 1)),
            Self::Reserved(_) => None,
            Self::Extended(width, height) => {
...
impl VuiParameters {
    ...
    pub const fn aspect_ratio(&self) -> Option<AspectRatioInfo> {
        self.aspect_ratio
    }

    pub const fn timing_info(&self) -> Option<&VuiTimingInfo> {
...
impl VuiTimingInfo {
    ...
    pub const fn num_units_in_tick(&self) -> u32 {
