...
| 2026-08-21 | 1.5 nine-camera live wall | Planned → real-server story   | 9 identities; 18 paced RTSP profiles; randomized 9:56 source offsets; 14.000s H.264 capture; decoded/nonblank pixel assertions; WebRTC diagnostics      | Azure narration and hosted publication run through the canonical demo workflow                                     |
