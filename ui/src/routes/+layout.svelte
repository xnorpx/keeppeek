...
>
	<Sidebar.Root collapsible="icon" class="z-40 border-r-0">
		<Sidebar.Header class="min-h-12">
			<a
				href={resolve('/')}
				class="flex h-8 items-center rounded-md px-2 text-sm font-semibold text-sidebar-foreground group-data-[collapsible=icon]:hidden hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 focus-visible:ring-sidebar-ring focus-visible:outline-none"
			>
				KeepPeek
			</a>
		</Sidebar.Header>
