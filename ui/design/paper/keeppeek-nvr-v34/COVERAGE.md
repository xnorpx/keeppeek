...
| 31 Peek → Keep: the rewind gesture     | Paper accepted              | `peek.desktop.rewind-ready`<br>`peek.desktop.rewind-to-keep`                                                                                                                             |            2/0/2 | `visual-harness/stories/Board31Rewind.stories.ts`                                                                     | `e2e/peek-rewind.e2e.ts`                                                                                                                                | None                                                |
...
- `cameras.desktop.add-wizard`
  - The server has no candidate-camera authentication or stream-probe command, so declared RTSP URLs cannot be presented as decoded proof before save.
